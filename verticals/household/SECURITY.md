...
## What HouseholdTasksAI receives

HouseholdTasksAI services handle authentication, account and credit state, catalog
...
## What HouseholdTasksAI does not receive

HouseholdTasksAI services do not receive household notes, financial or medical records,
...
for household, financial, and health information.

HouseholdTasksAI helps organize information and produce structured drafts. Users
must review dates, figures, quoted terms, responsibilities,
and clinician instructions before relying on or submitting an output.
